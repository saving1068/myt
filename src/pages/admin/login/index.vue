		...
		<div class="login-content">
			...
			<div class="login-wrap">
				...
				<div class="userLogin" v-if="tabIndex==0">
					<div class="infoBox">
						<div class="infoInp">
							<input type="text" v-model="loginForm.userName" placeholder="输入登陆账号">
						</div>
						<div class="infoInp">
...
<script>
	import canvasRenter from '@/lib/admin_bg'

	import {
		loginInfo,
		sign,loginMobile,sendMobileCode
	} from '@/api/admin'
	import {
		getUserResource,
		checkLogin,
